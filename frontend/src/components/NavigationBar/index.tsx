...
const NavigationBar: React.FC<NavigationBarProps> = ({ username, avatarSrc, dropdownOptions, navigationMenuItems }) => {
      ...
      <div className="navigation-bar__menu" role={'menu'}>
        {
          navigationMenuItems.map((item) => (
            <div className="navigation-bar__menu-item" key={item.key} onClick={item.onClick} role={'menuitem'}>
              {item.label}
            </div>
          ))
        }
      ...
      <div className="navigation-bar__icons">
        ...
        <div className="navigation-bar__icon">
          <div className="navigation-bar__dropdown">
            <Dropdown menu={{ items: dropdownOptions }} Icon={() => <Avatar size={'small'} src={avatarSrc} username={username} />} text={username} />
          </div>
        </div>
      </div>
    </div>
